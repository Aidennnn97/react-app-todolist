...
import { GrAdd } from "react-icons/go";
    ...
    return (
        <div>
            ...
            <form onSubmit={onTodoSubmit}>
                <input required className='todoinput' value={toDo} onChange={onChange} type="text" placeholder='what needs to be done...'/>
                <input className='addbtn' type="submit" value="+"></input>
            </form>
            <div>
